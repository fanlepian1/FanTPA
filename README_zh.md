...
一个功能强大的 Minecraft Fabric 传送模组，提供 TPA、Home、Back 等传送功能，具备高级特性。
...
### 核心特性
- **异步区块加载** - 先进的异步区块加载系统，确保传送过程流畅无卡顿
- **自定义语言支持** - 完整支持自定义翻译，内置 17+ 种语言
- **高版本兼容** - 支持 Minecraft 26.1+
...
### 高版本兼容
- 服务器版本要求：>= 26.1
- 定期更新以支持最新 Minecraft 版本

## 安装方法

### 服务器端安装
1. 确保您的服务器已安装 **Fabric Loader** 和 **Fabric API**
2. 将 `FanTPA-x.x.x.jar` 放入服务器的 `mods` 文件夹
3. 启动服务器，模组会自动生成配置文件
...
| `language.default-language` | string | "zh_cn" | 模组的默认语言 |
